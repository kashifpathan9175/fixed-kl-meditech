  ...
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="keywords"
          content="surgical cotton roll, IP standard cotton, sterilized cotton, pharma-grade cotton roll, medical cotton roll India"
        />
        <meta
          property="og:title"
          content="Surgical Cotton Rolls - K&L Meditech"
        />
        <meta
